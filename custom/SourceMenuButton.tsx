...
export const SourceMenuView = () => {
  ...
  const selectedSource = SOURCES.find(
    source => source.source === context.player.source,
  );
  const [localSourceId, setLocalSourceId] = useState<number | undefined>(
    selectedSource ? SOURCES.indexOf(selectedSource) : undefined,
  );
